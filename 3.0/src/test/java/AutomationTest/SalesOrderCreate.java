...
public class SalesOrderCreate 
{
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@tabindex='-1']")));
		...
		//wait for suggestion to load
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(30));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[.='DEMORET1']")));
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='DeliveryDate']")));
