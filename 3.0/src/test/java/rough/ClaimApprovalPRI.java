...
public class ClaimApprovalPRI 
{
	public static void main(String[] args) throws InterruptedException 
	{
        ...
        Thread.sleep(1000);
        Select year=new Select(driver.findElement(By.name("financialYear")));
		year.selectByVisibleText("2023-2024");

        //select claim type
        Thread.sleep(1000);
        Select claimType=new Select(driver.findElement(By.name("claimType")));
        claimType.selectByValue("2");
